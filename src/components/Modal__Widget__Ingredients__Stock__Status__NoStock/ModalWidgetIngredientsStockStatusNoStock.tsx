...
import styles from "./ModalWidgetIngredientsStockStatusNoStock.module.css";
...
const ModalWidgetIngredientsStockStatusNoStock: React.FC<ContainerProps> = ({
  isOpen,
  setIsOpen,
  ingredients,
      ...
      >
        <IonHeader>
          <IonToolbar>
            ...
            <IonTitle>
              {WidgetInventoryIngredientsStockStatusNoStock.name[l]}
            </IonTitle>
            <IonButtons slot="end">
              {needSave ? (
                <IonButton
...
export default ModalWidgetIngredientsStockStatusNoStock;
