...
import styles from "./ItemIngredientInSupply.module.css";
...
const ItemIngredientInSupply: React.FC<ContainerProps> = ({
  ingredient,
  skeleton = false,
  type = "button",
  isSelected = false,
      ...
      <IonLabel>
        ...
        <p>
          {skeleton ? (
            ...
            text[l].critic_limit + " " + ingredient?.managment?.limite
          )}
        </p>
      </IonLabel>
      {type === "reorder" ? (
...
export default ItemIngredientInSupply;
